...
<head>
    ...
    <script src="{{ asset('public/js/base64.js') }}"></script>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            <li class="nav-item">
                                <a class="nav-link" href="{{ url('contact/index') }}">Contacts</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ url('contact/shared') }}">Shared Contacts</a>
                            </li>
                             <li class="nav-item">
                                <a class="nav-link" href="{{ url('vcard') }}">Download VCard</a>
                            </li>
